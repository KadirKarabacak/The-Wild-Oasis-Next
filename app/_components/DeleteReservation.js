...
function DeleteReservation({ bookingId, onDelete }) {
    ...
    return (
        <button
            ...
            className="group max800:justify-center flex items-center gap-2 uppercase text-xs font-bold text-primary-300 flex-grow px-3 hover:bg-accent-600 transition-colors hover:text-primary-900"
        >
            {!isPending ? (
                <>
