...
function ReservationForm({ cabin, user }) {
    ...
    return (
        <div className="scale-[1.01]">
            <div className="bg-primary-800 text-primary-300 px-16 max500:px-4 max500:justify-evenly max400:px-0 py-2 flex justify-between items-center">
                <p>Logged in as</p>
            ...
            <form
                ...
                className="bg-primary-900 py-10 px-16 text-lg flex gap-5 flex-col max500:px-4"
            >
